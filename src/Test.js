...
export default function Test() {
  ...
  useEffect(() => {
    ...
    // Create the circles
    function createCircles(svg, circleData, emailData, selectedEmails, setSelectedEmails) {
      // Create the circles
      const circles = svg
        .selectAll("circle")
        .data(circleData)
    ...
    const circles = createCircles(svg, circleData, emailData, selectedEmails, setSelectedEmails);
